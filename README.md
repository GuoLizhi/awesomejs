...
3. [call实现原理](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/call.js)
4. [将字符串复制到剪切板](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/copyToClipboard.js)
5. [创建一个文件夹](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/createDirIfNotExists.js)
6. [函数柯里化](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/curry.js)
7. [防抖函数](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/debounce.js)
8. [简易版的深拷贝](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/deepCopy.js)
9. [判断当前处于移动端还是桌面端](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/detectDeviceType.js)
10. [判断父元素是否包含子元素](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/elementContains.js)
11. [检查指定的元素在视口中是否可见](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/elementIsVisibleInViewport.js)
12. [将数组扁平化](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/flatten.js)
13. [将一组表单元素转化为对象](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/formToObject.js)
14. [获取页面上所有的图片](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/getImages.js)
15. [获取当前页面的滚动位置](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/getScrollPosition.js)
16. [创建一个包含当前URL参数的对象](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/getURLParameters.js)
17. [检测一个元素上是否包含某个className](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/hasClass.js)
18. [隐藏页面上所有的隐藏元素](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/hideElement.js)
19. [发送http post请求](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/httpGet.js)
20. [发送http post请求](https://github.com/GuoLizhi/awesomejs/blob/master/handwriting/httpPost.js)
